  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <div className="lg:pl-64 pt-14 lg:pt-0">
        <header className="hidden lg:flex items-center justify-between bg-white border-b border-border px-6 py-3">
  ...
  return (
    <nav className="flex-1 p-4 space-y-1">
      ...
      <div className="pt-4 mt-4 border-t border-border">
        <Link to="/" className="flex items-center px-3 py-2.5 rounded-lg text-sm text-ink-secondary hover:bg-surface">
